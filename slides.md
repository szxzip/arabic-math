...
1. **传统**{style="color:yellow"}观点（伯特兰·罗素）：虽然伊斯兰科学在许多方面都有建树，但是**在发明上并不多**{style="color:yellow"}，相对的是**保存**{style="color:yellow"}了许多**古典**{style="color:yellow"}文明的**知识**{style="color:yellow"}，并后来反过来传到了中世纪欧洲。
